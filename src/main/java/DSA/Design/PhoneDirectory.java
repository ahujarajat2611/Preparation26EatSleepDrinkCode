...
public class PhoneDirectory {
	 ...
	 *            directory.
	 */
	// Maintain what is available with me
	 ...
	 */
	// iterate and return first number and then remove that number from set
	public int get() {
		if (set.isEmpty()) {
			return -1;
		}
		// remove if if its taken 
	...
	// release this number from the set 
