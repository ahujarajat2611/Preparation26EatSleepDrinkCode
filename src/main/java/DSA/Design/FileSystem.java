...
return a list that only contains this file's name. If it is a directory path, return the list of file and directory names in this directory. Your output (file and directory names together) should in lexicographic order.
...
If the file doesn't exist, you need to create that file containing given content. If the file already exists,
