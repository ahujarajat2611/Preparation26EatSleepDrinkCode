...
import static DSA.trees.binary.BinaryTree.levelOrder;
...
public class MergeTwoBinaryTrees {
    ...
    public BinaryTreeNode<Integer> mergeTrees(BinaryTreeNode<Integer> r1, BinaryTreeNode<Integer> r2) {
        if (null == r1) {
            // since you are creating new tree, you need to return the clone of R2 .. cant just return R2
            // you can but in that case you will modify the current tree if thats fine withyou !!!
            // or it would have two parents means two left or two right pointing to this node which also can be okay !!!!!!
            return r2;
        }
        if (null == r2) {
            return r1;
