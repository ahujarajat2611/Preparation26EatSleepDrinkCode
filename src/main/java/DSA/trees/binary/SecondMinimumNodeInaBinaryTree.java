...
public class SecondMinimumNodeInaBinaryTree {
	...
	private void utilMethodMine(BinaryTreeNode<Integer> root) {
		if (null == root )
			return ;
		...
		if(root.left!=null && root.right!=null){
			utilMethodMine(root.left);
			utilMethodMine(root.right);
		}
	}
	...
	public static void main(String[] args) {
		...
		obj.utilMethodMine(ob.root);
		System.out.println(obj.secondmin);
	}
