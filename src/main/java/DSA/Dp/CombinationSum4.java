...
public class CombinationSum4 {
	...
	public int combinationsSum4UsingDpSimplerANDNOTWORKINGANDWILLNOTWORKANDNEVERWORKED(int a[], int sum) {
		if (null == a)
			return 0;
		int t[] = new int[sum + 1];
		t[0] = 1;
	...
	public static void main(String args[]) {
		...
		res = obj.combinationsSum4UsingDpSimplerANDNOTWORKINGANDWILLNOTWORKANDNEVERWORKED(a,4);
		System.out.println(res);
	}
