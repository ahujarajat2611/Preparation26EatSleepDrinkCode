...
public class CreateMaxNumWithKDigitsFromTwoArrays {
	...
	public static int[] createMaxNumber(int[] nums1, int[] nums2, int k) {
		...
		/*
		 * int publish = 0, end = k; // if 'k' is less than size of both arrays
		 ...
		 * < maxLenArr.length) { publish = 0; end = k; } else if (k >
		 ...
		 * 
		 * publish = k - minLenArr.length; end = maxLenArr.length; } else { // if
		 ...
		 * 
		 * publish = k - minLenArr.length; end = k; }
		 */
