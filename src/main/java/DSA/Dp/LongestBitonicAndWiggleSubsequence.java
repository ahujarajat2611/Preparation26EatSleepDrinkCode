 ...
 */
public class LongestBitonicAndWiggleSubsequence {
	...
	public static int longestWiggleSubsequence(int a[]) {
		...
		ConsoleWriter.printArray(inc);
		ConsoleWriter.printArray(dec);
	...
	public int bitonicDpOn2(int[] a) {
		...
		ConsoleWriter.printArray(lis);
		ConsoleWriter.printArray(lds);
		int max = 1;
		for (int i = 0; i < n; i++) {
