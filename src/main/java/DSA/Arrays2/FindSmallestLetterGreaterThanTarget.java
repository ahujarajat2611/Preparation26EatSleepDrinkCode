...
public class FindSmallestLetterGreaterThanTarget {
	...
	// Time : O(logn), Space : O(1)
	public char nextGreatestLetterMy(char[] a, char target) {
	...
	public static void main(String[] args) {
		...
		res = obj.nextGreatestLetterMy(new char[] { 'c', 'f', 'j' }, 'a');
		System.out.println(res);
		...
		res = obj.nextGreatestLetterMy(new char[] { 'c', 'f', 'j' }, 'c');
		System.out.println(res);
		System.out.println("======");
		...
		System.out.println(res);
		res = obj.nextGreatestLetterMy(new char[] { 'c', 'f', 'j' }, 'd');
		System.out.println(res);
		System.out.println("======");
		...
		System.out.println(res);
		res = obj.nextGreatestLetterMy(new char[] { 'c', 'f', 'j' }, 'g');
		System.out.println(res);
		...
		System.out.println(res);
		res = obj.nextGreatestLetterMy(new char[] { 'c', 'f', 'j' }, 'j');
		System.out.println(res);
		System.out.println("======");
		...
		System.out.println(res);
		res = obj.nextGreatestLetterMy(new char[] { 'c', 'f', 'j' }, 'k');
		System.out.println(res);
		System.out.println("======");
