...
public class HIndex2 {
	...
	public int hIndex(int[] a) {
		/*
		 * when array is reverse
		 * sorted it's easier to understand.
		  * Two steps to
		 * convert this program to that way 1)
		 * in place m+1, put n-m 2) swap
		...
		while (l <= r) {
			int m = (l + r) >> 1;
			// we find to find lowest index in this case .
			// thats why equality case we are moving one by right
