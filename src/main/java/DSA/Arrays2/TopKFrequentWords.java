...
public class TopKFrequentWords {
	...
	public List<String> topKFrequent(String[] words, int k) {
		...
		// value ->> count array 
		// make priority queue andd comparator based on value
		// and then make min queueueuueue
		// iteratoe keep addding entry if count is more or size of queue is less than k 
