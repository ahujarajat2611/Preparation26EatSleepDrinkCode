...
public class MonotoneIncreasingDigits {
	...
	// from beginning keep moving if it is increasing
	// onnce you see lump and move backwards and decrasing value
	// to see if previous value is more than current vlaue
	// after decremening current value
	// one loop stops you know you have to write 9 in remaining coming diguts
