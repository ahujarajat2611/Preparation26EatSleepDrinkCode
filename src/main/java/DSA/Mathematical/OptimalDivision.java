 ...
 *         the adjacent integers will perform
 *         the float division. For example, [2,3,4] -> 2 / 3 / 4.
 * 
 *         However,
 *         you can add any number of parenthesis at any position to
 *         change the priority of operations.
 *         You should find out how to add
...
public class OptimalDivision {
	...
	/* @formatter:off
	 * 
	 * (100/10/2) will have two options
	  * (a) (100/10)/2 or (b)100/(10/2)
	 *  (a) (100/10)/2 is nothing but(100/10*2)
	 *  because (100/10)/2=> (10/2) => 5 is also can be written as (100/20)
