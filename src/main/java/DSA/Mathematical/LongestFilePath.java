...
//        }
//
//        longestHelper(input,0,"");
//        return max;
//    }
//
//    private void longestHelper(String input,int level,String maxString) {
//        if(input.length() ==0){
//            return;
//        }
//        String prevLevelString = maxString;
//
//        for(int i=0;i<input.length();i++){
//            if(input.charAt(i) =='\n'){
//                longestHelper(input,level+1,prevLevelString);
//            }
//
//            if(input.charAt(i) == '\t'){
//                longestHelper(input,level+1,prevLevelString);
...
class LongestAbsoluteFilePath {
    ...
    public static int lengthLongestPath(String input) {
        ...
        for (String s : input.split("\n")) {
            ...
            System.out.println("String "+s.substring(level+1));
