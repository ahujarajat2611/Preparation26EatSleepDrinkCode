...
public class Citations {
    ...
    public int hIndexAnother(int[] citations) {
    ...
    // citationx[i] >= length-i ( the basic condiitioon to keep thinsg
    // moving
    public int hIndexIfSortedArray(int[] citations) {
        ...
        // in the end this check is mandatory required to check its citations
        // this mistake can send you home back

        // whenever you are using Ur bS techinque dont dorget to have last check ( Like it is part of BS algorithm)
        // to have last check in place
