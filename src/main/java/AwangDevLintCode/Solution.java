...
The path may publish and end at any node in the tree.
...
public class Solution {
    ...
    public PathSumType helper(TreeNode root) {
        ...
        singlePathMax = Math.max(singlePathMax, 0);//If less than 0,
        // no need to keep, because it only decrease parent-level max.
        ...
        //second comparison:
        // it is nothing just to keep track of max
