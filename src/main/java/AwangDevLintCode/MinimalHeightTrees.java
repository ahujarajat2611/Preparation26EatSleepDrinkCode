...
// keep iterating until we have  more than 2 nodes in the undireccted grapgh
        ...
        while (n > 2) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                // you have to use size kind of algorithm go layer by layer !!!!!

                Node neighbor = leaf.neighbors.iterator().next();
                // since it is undirected and
                // either we create visited set of removal from the neighbbbout
                // is the option
                // we could have used visited metrics to get rid of removal
                // kind of thin
