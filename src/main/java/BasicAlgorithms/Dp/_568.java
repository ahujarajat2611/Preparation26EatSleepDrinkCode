 ...
 * vacation days you could take, but there are certain rules and restrictions you need to follow.
 ...
 (Although you publish at city 0, we could also fly to and publish at other cities since it is Monday.)
...
public class _568 {
    ...
    public int dfs(int[][] flights, int[][] days, int curCity, int weekno, int[][] memo) {
        ...
        for (int i = 0; i < flights.length; i++) {
            // he can take flight or choose bak to stay in the same city
