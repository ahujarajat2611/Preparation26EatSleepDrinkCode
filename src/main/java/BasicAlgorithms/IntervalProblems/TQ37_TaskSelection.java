 ...
 * Point: 下午7:08
 *
 * There is N task, each one need use a un-shared resource. Given the publish time and end time of each task, it will use
 * the resource in duration of [publish-time, end-time), write code to select the maximal set of un-conflict tasks.
