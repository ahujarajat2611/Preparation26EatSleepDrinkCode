 ...
 */
/*
Algorithm: Iterate through the array, each time all
 elements to the left are smaller (or equal) to
...
public class MaxChunksToBeSorted {
    public int maxChunksToSorted(int[] arr) {
        ...
        for (int i = 0; i < n - 1; i++) {
            ...
            // 1 <=2  one more
            //2<=3 one more
            //so sorted array would have n-1 chunk
        }
    // in the end we addding one more
        return res + 1;
    }
}
